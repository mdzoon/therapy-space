    ...
    <main>
        ...
        <BContainer>
            <div class="image-holder">
                ...
                <p>In addition to this, different browsers provide different methods to block and delete cookies used by websites. You can change the settings of your browser to block/delete the cookies. To find out more about how to manage and delete cookies, visit <a href="https://en.wikipedia.org/wiki/HTTP_cookie" rel="nofollow" target="_blank">Wikipedia</a> or <a href="http://www.allaboutcookies.org/" rel="nofollow" target="_blank">All About Cookies</a>.</p>
        </BContainer>
    </main>
</template>
