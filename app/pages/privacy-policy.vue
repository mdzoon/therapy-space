<template>
    <main>
        ...
        <BContainer>
            ...
            <p>
                My Privacy Policy is guided by the General Data Protection Regulation (GDPR) which ensures that your personal data is protected and handled with care. As a client of psychological therapy, any information you share, including personal details, session notes, and therapy-related data, is treated with the utmost confidentiality and security
            </p>
